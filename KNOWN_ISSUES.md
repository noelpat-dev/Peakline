...
- Root-tab selection must remain observation-isolated from `RootTabView`'s SwiftData-backed notification and Preview-warm signatures. Keep the native switch free of whole-screen animation and defer Splits/History freshness work until after their prepared snapshot is visible.
