...
- Today quick actions for Sleep and Nutrition present exact prepared first-viewport values before their live query-backed dashboards attach. Progress uses prepared summaries and bounded exercise-row values; live workout relationship projection remains post-frame and generation-checked.
