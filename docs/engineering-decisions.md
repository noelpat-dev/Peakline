...
I maintain unit, UI, and focused performance checks alongside the implementation. The repository keeps stable budgets and route definitions in [Performance Acceptance](performance.md), while exact totals and measurements live in a dated [verification record](verification-2026-09-17.md). That avoids turning one machine's sample into a timeless product claim.
